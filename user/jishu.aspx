<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jishu.aspx.cs" Inherits="user_jishu" %>
...
<table width="98%"  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#3A76AF">
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td width="75%" height="25"></a>
        <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="添加技术" />
      </td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td height="25" class="style1" colspan="2">
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="22" Name="classid" Type="Int32" />
            </SelectParameters>
            <DeleteParameters>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="id" 
                    DataNavigateUrlFormatString="Addjishu.aspx?jishu={0}" Text="编辑" />
