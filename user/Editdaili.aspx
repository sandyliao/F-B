<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Editdaili.aspx.cs" Inherits="user_Editdaili" %>
...
<table width="98%"  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#3A76AF">
  <tr> 
    <td height="23" colspan="2"><div align="center" class="style3"><font color="#FFFFFF"><strong>代理机构</strong></font></div></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    ...
    <td width="75%" height="25">
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            SelectCommand="SELECT * FROM [gsclass] WHERE ([classid] = ?)">
            <SelectParameters>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="id" 
                    DataNavigateUrlFormatString="dailixx.aspx?id={0}" Text="编辑" />
